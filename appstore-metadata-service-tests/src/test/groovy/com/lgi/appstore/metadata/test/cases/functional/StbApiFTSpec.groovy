...
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.CATEGORY
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.DESCRIPTION
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.LIMIT
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.MAINTAINER_NAME
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.NAME
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.OFFSET
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.PLATFORM
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.TYPE
import static com.lgi.appstore.metadata.test.framework.model.request.ApiStbApplicationsQueryParams.VERSION
...
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.getFieldValueFromApplication
