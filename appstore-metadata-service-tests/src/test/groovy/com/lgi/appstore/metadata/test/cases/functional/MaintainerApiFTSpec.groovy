 ...
 */
package com.lgi.appstore.metadata.test.cases.functional
...
import com.lgi.appstore.metadata.test.AsmsFeatureSpecBase
...
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.CATEGORY
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.DESCRIPTION
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.LIMIT
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.NAME
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.OFFSET
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.PLATFORM
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.TYPE
import static com.lgi.appstore.metadata.test.framework.model.request.ApiMaintainerApplicationsQueryParams.VERSION
import static com.lgi.appstore.metadata.test.framework.model.request.ApplicationMetadataBuilder.builder
import static com.lgi.appstore.metadata.test.framework.model.request.QueryParams.mapping
...
import static com.lgi.appstore.metadata.test.framework.model.response.PathBase.anyOf
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_DEV_ADDRESS
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_DEV_CODE
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_DEV_EMAIL
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_DEV_HOMEPAGE
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_DEV_NAME
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_FIRMWARE_VER
import static com.lgi.appstore.metadata.test.framework.steps.MaintainerViewSteps.DEFAULT_PLATFORM_NAME
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.appKeyFor
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.assembleSearchCriteria
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.mapAppsToKeys
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.pickRandomCategory
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.pickRandomCategoryExcluding
import static com.lgi.appstore.metadata.test.framework.utils.DataUtils.randId
